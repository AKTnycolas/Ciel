...
exports.run = async (client, message) => {
  ...
  const mainLanguage =
    acro.get(guild.preferredLocale) || "Língua não encontrada";
  ...
  const pag1 = new MessageEmbed()
    ...
    .addField(`${Emojis.get("name")} Nome: `, guild.name)
    .addField(`${Emojis.get("coroa")} Dono(a): `, ownerTag)
  ...
  const pag2 = new MessageEmbed()
    .setAuthor({ name: guild.name, iconURL })
    .setThumbnail(iconURL)
    .addField(`${Emojis.get("name")} Id: `, guild.id)
    .addField(`${Emojis.get("boost")} Boosts: `, totalBoost)
    .addField(`${Emojis.get("shield")} Nível de Verificação: `, vLevel)
    .addField(`${Emojis.get("channel")} Canais: `, stripIndents`\`\`\`
    ...
    .addField(`${Emojis.get("online")} Presenças: `, stripIndents`\`\`\`
    ...
    .addField(`${Emojis.get("users")} Membros: `, stripIndents`\`\`\`
    ...
    .addField(`${Emojis.get("full_heart")} Emojis: `, stripIndents`\`\`\`
    Total: ${emojiServer[0]}
